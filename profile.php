			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo " Hola ".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						<li><a href="cart.php" style="text-decoration:none; "><span class="glyphicon glyphicon-shopping-cart"></span> Carrito</a></li>
						<li class="divider"></li>
						<li><a href="customer_order.php" style="text-decoration:none;"><span class="glyphicon glyphicon-credit-card"></span> Pedidos</a></li>
						<li class="divider"></li>
						<!--li><a href="" style="text-decoration:none; color:blue;">Chnage Password</a></li-->
						<li class="divider"></li>
						<li><a href="logout.php" style="text-decoration:none; "><span class="glyphicon glyphicon-circle-arrow-left"></span> Cerrar Sesión</a></li>
					</ul>
				</li>
